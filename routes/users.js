...
function convertCodeToAccessToken (code) {
	return axios.get(`https://graph.facebook.com/oauth/access_token?client_id=${facebookconfig.clientId}&client_secret=${facebookconfig.clientSecret}&code=${code}&redirect_uri=${encodeURIComponent(facebookconfig.finishUrl)}`)
}
